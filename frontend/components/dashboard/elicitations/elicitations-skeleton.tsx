...
// Mirrors ElicitationsPage's real layout (PageHeader + SectionHeader + ElicitationsKpiTiles
// grid + pending questions list) so nothing jumps when GET /analytics/elicitations resolves.
// No filter bar here, unlike Vendors/Categories - this page takes no query params.
export function ElicitationsSkeleton() {
  return (
    <div
