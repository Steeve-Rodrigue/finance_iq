...
// Mirrors VendorsPage's real layout (PageHeader + VendorFilters bar + SectionHeader +
// VendorsKpiTiles grid + vendor table + charts section) so nothing jumps when
// GET /analytics/vendors resolves.
