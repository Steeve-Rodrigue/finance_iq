...
// Same mixed multi-hue palette as top-vendors-chart.tsx, so the two pie charts read as one
// visual family instead of category spend looking like a different app.
const SLICE_COLORS = [
  "#f2b705", // gold
  "#7c5cbf", // violet
  "#3f9c6d", // green
...
export function SpendingByCategoryChart({
  ...
  // Nightingale/rose chart - same treatment as top-vendors-chart.tsx (petal length scales
  // with spend, white-bordered slices with a drop shadow, horizontal legend instead of
  // on-slice labels, same mixed palette). Memoized: `option` must keep a stable reference
